...
#В целом всё отлично, но обратите внимание на результат вывода 5 задания.
# Если попытаться добавить не макс/мин элемент, которого ещё не было в рейтинге, он добавится 2 раза.
# Нужно просто добавить break к последнему случаю внутри цикла for. В остальном - отлично!
